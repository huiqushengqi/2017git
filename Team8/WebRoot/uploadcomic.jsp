...
<html>
  <head>
    ...
    function addcomic(){
        alert("添加漫画了");
		var str = $("#adddiv").html();
		str = str +"<div class='col-md-10'><input type='file' id='exampleInputFilecomic" + index + "' name = 'comiclink"+index+"'></div>";
		$("#adddiv").html(str);
		index++;
        }
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b>创建漫画</b>
                      </div>
                    ...
                    <div class="panel-body">
                      ...
                      <form novalidate="" role="form" class="form-horizontal"  method = "post" action="ComicServlet?flag=createcomic" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-10">
                          <select name="type">
				         <c:forEach items="${requestScope.typelist}" var="comictype">
				        ${comictype}
				      <option value= ${comictype.type_id } >${comictype.type_name}</option>
				   </c:forEach>	
				</select>
              </div>
                        <!--   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name = "type">
