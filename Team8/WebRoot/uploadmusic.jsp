            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b>上传音乐</b>
                      </div>
                    ...
                    <div class="panel-body">
                      <form novalidate="" role="form" class="form-horizontal"  method = "post" action="MusicServlet?flag=uploadmusic" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                          <label class="col-md-2 control-label">歌曲封面</label>
                          <div class="col-md-10">
                           <input type="file" id="exampleInputFilecover" name = "cover">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-md-2 control-label">歌曲类型</label>
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="type" >
                          
                        </div>
                        <div class="form-group">
                          <label class="col-md-2 control-label" for="description">歌曲演唱者</label>
                          <div class="col-md-10">
                          <input type="text" required="" placeholder="Subject" id="subject" class="form-control" name="singer">
                             </div>
                        </div>
                        <div class="form-group">
                          <label class="col-md-2 control-label" for="description">歌曲简介</label>
                          <div class="col-md-10">
                          <input type="text" required="" placeholder="Subject" id="subject" class="form-control" name="abstract">
                             </div>
                        </div>
                        <div class="form-group">
                          <label class="col-md-2 control-label">歌曲</label>
                          <div class="col-md-10">
                           <input type="file" id="exampleInputFilecomic" name = "songlink">
                          </div>
                        </div>
                        <div class="form-group">
