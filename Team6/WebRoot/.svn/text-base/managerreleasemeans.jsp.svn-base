	...
	<div id="header">
    	<div class="wrapper">
    		...
    		<ul id="navheader" class="reset">
    			 ...
    			 <li><a rel="nofollow" href="#">公司</a></li>
    			<li><a target="_blank" href="/Team6/Controller?flag=showdiscuss">讨论区</a></li>
    		    <li><a rel="nofollow" href="ManagerServlet?flag=querynocheckjob">审核企业的岗位</a></li>



	    	   <li class="current"><a href="#">发布学习资料</a></li>
...
<button type="button" id="cboxNext"></button><button id="cboxSlideshow"></button><div id="cboxLoadingOverlay" style="float: left;"></div>
...
<div id="cboxBottomRight" style="float: left;"></div></div></div><div style="position: absolute; width: 9999px; visibility: hidden; display: none;"></div></div>
</body>
</html>