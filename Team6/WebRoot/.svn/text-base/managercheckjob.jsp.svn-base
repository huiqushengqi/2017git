    ...
    <div id="container">
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	<form action="ManagerServlet?flag=checkjob" method="post" id="jobForm">
                    	
                            <input type="hidden" value="${requestScope.job.job_id }" name="jid">
                            <input type="hidden" value="${requestScope.job.job_issue }" name="jissue">
                            <input type="hidden" value="${requestScope.job.job_date }" name="jidate">
                            <table class="btm">
                            	<tbody>
                            	<tr>
                                	...
                                	<td>
                                        ...
                                        <input type="text" placeholder="请输入职位类别" value="${requestScope.job.job_type.tech_name }" name="jtype" id="positionName">
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                                	<td>岗位名称</td>
                                	<td>
                                    	<input type="text" placeholder="请输入职位名称，如：Java工程师" value="${requestScope.job.job_name }" name="jname" id="positionName">
                                     </td>
                                </tr>
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="薪资" value="${requestScope.job.job_salary }" name="jsalary" id="salaryMin">
                                                <span>k</span>
                                            </div>
                                        </div>
                                    </td>
                                	...
                                	<td>
                                    	<input type="hidden" id="positionType" value="" name="positionType">                                     
                                        <input type="text" placeholder="公司所在的城市" value="${requestScope.job.job_address }" name="jaddress" id="positionName">
                            	<tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td>
                                	    ...
                                	    <input type="text" placeholder="请输入工作经验" value="${requestScope.job.job_exp }" name="jexp" id="positionName">
                                    	</div>
                                    </td>
                                </tr>
                                <tr>
                                	...
                                	<input type="text" placeholder="请输入对学历的要求" value="${requestScope.job.job_education }" name="jeducation" id="positionName">
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>岗位描述</td>
                                	<td>
                                    	<p><textarea style="resize: none;" rows="10" cols="60" name="jdescription">${requestScope.job.job_description }</textarea></p> 
                                ...
                                <tr>
                                	<td width="25"></td>
                                	<td colspan="2">
                                	<input type="submit" value="通过"  class="btn_32">
                                	<input type="button" value="不通过" onclick="location.href = 'managerindex.jsp'" class="btn_32">
                                    	<!--<input type="submit" value="审核" id="jobPreview" class="btn_32">
