...
var b=false;
  function checkuser(op){
	   $.get("UserServlet",{username:op,flag:"docheckusername"},function(data){
		   if(data==0){
			   $("#mydiv1").html("<font color='red'>用户不能为空</font>");
			   return b;
			   }
		   if(data==1){
...
<body id="login_bg">
	<div class="login_wrapper">
    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
        	<form id="loginForm" action="UserServlet?flag=dochecklogin" method="post">
				<input type="text" id="email" name="email" value="" onblur="checkuser(this.value)" onfocus="cleanuser()" tabindex="1" placeholder="请输入用户名" /><div id="mydiv1"></div>
