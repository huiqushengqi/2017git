					...
					<dd>
						<form action="canInterviewResumes.html" method="get" id="filterForm">
							...
							<ul class="reset resumeLists">
								...
								<c:forEach items="${requestScope.joblist}" var="job" varStatus="jobstatus">
									<li data-id="1686182" class="onlineResume"><label class="checkbox"> <input type="checkbox"> <i></i>
									</label>
										<div class="resumeShow">
											<a title="预览发布的岗位" class="resumeImg" href=""> <img src="style/images/default_headpic.png">
											</a>
											<div class="resumeIntro">
												<h3 class="unread">
													<a target="_blank" title="预览jason的简历" href=""> ${job.job_name } </a> <em></em>
												</h3>
												<span class="fr">发布时间：${job.job_date }</span>
												<div>${job.job_type.tech_name} | ${job.job_address } | ${job.job_salary } | ${job.job_education} | ${job.job_exp } <br/> ${job.job_description}</div>
