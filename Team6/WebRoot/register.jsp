...
var b=false;
  function checkuser(op){
	   $.get("UserServlet",{flag:"docheckuser",username:op},function(data){
		   if(data==0){
		   ...
		   if(data==2){
			   $("#mydiv1").html("<font color='red'>用户已经存在</font>");
			   }
		   });
	  }
  function cleanuser() {
...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm" action="UserServlet?flag=doregister" method="post">
            	...
            	<input type="text" id="email" name="email" tabindex="1" placeholder="请输入用户名"  onblur="checkuser(this.value)" onfocus="cleanuser()"/><div id="mydiv1"></div>
    ...
    function myjob1(){
        location.href="registercompany.jsp";
        }
