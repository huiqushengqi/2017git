			...
			<div class="news">
				...
				<div class="cont01">
					<div class="product_main">
						<dl>
							<dt>市场/营销/开拓专员</dt>
							<dd>1、收集客户信息，邀约客户上门参观促成报名； 在高校组织招生宣传活动，提高品牌知名度；</dd> 
							<dd>2、拜访高校专业负责人，洽谈培训合作事宜； </dd>
							<dd>3、专科以上学历，3年以上市场拓展、市场销售工作经验有建筑行业、市场营销等相关专业者优先；</dd> 
							<dd>4、要求品行端正、工作责任心强，有积极的市场开拓精神的工作态度；负责做好市场调研数据信息及客户资料的归档、使用管理工作；</dd> 
						</dl>
						<dl>
							<dt>软装设计师</dt>
							<dd>1、根据客户定位及预算，配合室内设计师完成设计方案，为客户提供家庭室内软装整体解决方案；</dd> 
							<dd>2、执行公司的销售目标和促销计划，准确解答客户疑问，并引导客户进行消费购物； </dd>
							<dd>3、大专以上学历，室内设计、环艺或相关专业毕业,3年以上软装设计经验，autoCAD、3DMAX、Photoshop、Illustrator等设计软件熟练者优先；</dd> 
						</dl>
						<dl>
							<dt>市场部专员</dt>
							<dd>1、负责接待有家装、别墅、改扩建室内装饰需求的客户，向其宣传企业、服务及产品；</dd> 
							<dd>2、收集客户信息，邀约客户上门参观促成报名，签单； 完成部门经理下达的指标，不断提升业绩并完成工作指标。</dd> 
							<dd>3、专科以上学历，2年以上市场拓展、市场销售工作经验有建筑行业、市场营销等相关专业者优先； </dd>
							<dd>4、擅长沟通，语言表达能力强，擅长察言观色，能正确判断客户意图，对家装业务有兴趣有恒心，执行力强。</dd>
						</dl>
						<div class="page">
							<a href="job.html">首页</a><a href="job_1.html">上页</a><a href="job_2.html">下页</a><a href="job_2.html">尾页</a>
						</div>
