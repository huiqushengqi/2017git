			...
			<div class="news">
				<div class="tab01">
					 <ul class="m_p clearfix">
						...
						<li><a href="myquote.action?name=material_infor1&typename=地砖&page=1">地&nbsp;&nbsp;&nbsp;&nbsp;砖</a></li>
						<li class="active"><a href="myquote.action?name=material_infor2&typename=壁纸&page=1">壁&nbsp;&nbsp;&nbsp;&nbsp;纸</a></li>
			 ...
			 <c:forEach var="mat" items="${requestScope.mt.list }" begin="${(requestScope.page-1)*size}"  end="${ (requestScope.page)*size-1}"  varStatus="stus">
				...
				<div class="page">
							<pt:page pageIndex="${requestScope.page}" url="myquote.action?name=material_infor2&typename=壁纸&" pageMax="${requestScope.countpage}"/>
						</div>
			   </div><!--infor for end-->
