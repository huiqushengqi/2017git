...
function mydelete(op){
   if(confirm("你真的真的要删除这项？")){
           
       location.href="management.action?mag_id="+op;
	   }	
}
function myedit(op){
	 location.href="management.action?mag_id="+op;
			...
			<div class="news">
				<div class="tab01">
					 <ul class="m_p clearfix">
						<li><a href="company.jsp">公司简介</a></li>
						<li><a href="zizhi.jsp">公司资质</a></li>
						<li class="active"><a href="management.action">管理团队</a></li>
					 </ul>
				</div>				
				<div class="cont01">
					<div class="company">						
						...
						<li class="clearfix">
								<div class="area_l">
									<img src="${mytob.mag_img}" />
								</div>
								<div class="area_r company_r">
									<dl>
										<dt>${mytob.mag_name}</dt>
										<dd>职务：${mytob.mag_job}</dd>
										<dd>简历：${mytob.mag_about}</dd>
	...
	<div class="foot">
		...
		<div class="foot_main">
			<ul>
				...
				<li>版权所有 Copyright(c) 2010  聆海建筑装饰工程有限公司  更多模板：
			</ul>
		</div>
