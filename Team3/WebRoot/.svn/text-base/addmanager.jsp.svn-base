...
<jsp:include page="AdminCom.jsp"></jsp:include> 
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="Admin.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="manager1.action?page=1">员工管理</a><span class="crumb-step">&gt;</span><span>新增设计师</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="addmangaer.action" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>姓名：</th>
                            <td>
                             <input class="common-text required" id="name" name="mag_name" size="10" onblur="checkname()" onclick="cleanname()">
                             <lable id="myid"></lable>
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="mag_job" size="20" value="" type="text" onblur="checktitle()" onclick="cleantitle()">
                                    <lable id="myid1"></lable>
                                </td>
                            </tr>
                           <tr>
                                <th>简介：</th>
                                <td><textarea name="mag_about" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>          
                        </tbody></table>  
                        </div>
                         <div class="upload">   
                           <input class="file_input" type="file" multiple id="avc" name="mag_img" />  
