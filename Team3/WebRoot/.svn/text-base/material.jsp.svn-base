			...
			<div class="news">
				<div class="tab01">
					 <ul class="m_p clearfix">
						<li class="active"><a href="myquote.action?name=material&typename=墙砖&page=1">墙&nbsp;&nbsp;&nbsp;&nbsp;砖</a></li>
				...
				<div class="page">
							<pt:page pageIndex="${requestScope.page}" url="myquote.action?name=material&typename=墙砖&" pageMax="${requestScope.countpage}"/>
						</div>
			   </div><!--infor for end-->
