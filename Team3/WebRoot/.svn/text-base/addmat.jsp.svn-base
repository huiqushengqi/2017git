...
<jsp:include page="AdminCom.jsp"></jsp:include> 
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="Admin.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="material.jsp">饰材管理</a><span class="crumb-step">&gt;</span><span>新增饰材</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="addall.action" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>饰材名称：</th>
                            <td>
                             <input class="common-text required" id="name" name="mat_name" size="10" >
                            </td>
                        </tr>
                         <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="mat_price" size="20" value="" type="text">
                                </td>
                            </tr>
                           <tr>
                                <th>简介：</th>
                                <td><textarea name="mat_about" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"></textarea></td>
                            </tr>          
                        </tbody></table>  
                        </div>
                         <div class="upload">   
                           <input class="file_input" type="file" multiple id="avc" name="mat_cover"/>  
