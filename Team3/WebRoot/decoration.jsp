...
<div class="blank10"></div>
	...
	<div class="container clearfix">
		...
		<div class="area_r c_r">
			<div class="all_title">
				<h2>
					<span class="title_right">装修贴士</span>
				</h2>
				<div class="explain">
					<dl>
						<dt>家装中甲醛有哪些危害？它是从哪里来的？</dt>
						<dd>在甲醛含量超标的环境中生活会出现甲醛中毒症状，一般的表现为头晕、气味辛辣刺鼻、流泪、心悸。长期接触甲醛，还会增加导致癌症的可能性。</dd> 
						<dd>在家装材料中，如复合地板、一些家具、橱具的背板、面板等使用的是密度板，由于密度板中使用的是尿醛胶，甲醛的含量就较高，目前国家对密度板中的甲醛含量制定了严格标准，因此在选购时应注意材料的品牌、产地及检测报告。装修后的房间也必须充分通风换气，不能马上入住。</dd> 
						<dd>其它人造板如大芯板、三合板、五合板等由于使用的胶合剂以醋丙乙烯为主，因此甲醛含量相对较低。</dd> 
						<dd>甲醛释放量是衡量产品释放甲醛气体多少的一项指标。目前装饰板材中使用的胶粘剂仍以脲醛树脂为主，板材中残留的未参与反应的甲醛会逐渐向周围的环境释放。甲醛、氨气的释放和放射性污染是家庭装修中比较重要的三个污染源，尤其是氨气和放射性，如果不通过仪器，人们根本无法觉察出它们的存在。因此您可以通过专家检测，判断居住环境是否有这些污染。</dd>
					</dl>
					<dl>
						<dt>卧室的装修，由于居住主体的不同，配色也不尽相同。 </dt>
						<dd>1、主卧室。主周应以温馨为主，地面宜用木地板。不排除在夫妻双方审美观丰同的情况下采取特定风格配色。</dd> 
						<dd>2、次卧室。同样应以温馨为主，次卧室一般老人居住的，装修时要考虑老人的行动方便和喜好。 </dd>
						<dd>3、儿童房。宜用一些较为活泼的颜色。比较常用的配色是男孩子房间用蓝调，女孩子房间用粉红调或者为黄调。也可以使用一些带卡通动物或花、植物图案的墙纸。小孩房间也可以多放置一些玩具架。儿童房可经使用木地板，这有利于孩子摸爬而不至于受凉。如果没有条件设置木地板的，也可以使用儿童胶垫，这些胶垫多数五颜六色，还有一些益智图案或者字母。 </dd>
						<dd>4、保姆房。一般不需要做太多的装饰，处理好墙、地、顶即可。</dd>
 					</dl>
					<dl>
						<dt>房间内如何摆放绿色植物？</dt>
						<dd>如果客厅和书房里用，要求放置朴素、美观、典雅、植株秀美的观叶植物。如发财树、橡皮树、龟背竹、一叶兰、吊兰、酒瓶兰、君子兰等，这些植物能给人一种高贵气派感，它们还能吸附空气中的尘埃，增加空气湿度，吸收二氧化碳，同时释放出氧气，杀灭空气中的有害细菌。</dd>  
						<dd>如果卧室里用，要放置淡雅安神的观叶植物，做到少而精，在窗台或墙角处摆放一两盆即可，如文竹、富贵竹、吊兰等，梳妆台旁可在花瓶中摆放一束鲜花，它可让你对新的一天充满活力。</dd>
						<dd>室内摆花应注意的是：要主次分明，不要摆放太多。喜光的摆在南窗边，耐阴的摆在阴凉的地方，高大的摆在墙角处不挡视线的地方，对有空调的房间要做到经常开窗换气，以防病虫害的发生。这样才能不影响绿色植物的生长，才能增强其观赏效果。另外，还要根据室内墙面和家具的颜色来摆放，如果墙面和家具颜色较深，则要摆放浅色植物，以调和房间里的明暗度；如果墙面和家具的颜色较淡雅，摆放绿色观叶植物是最佳选择。特别是在办公室和书房里，摆放绿色植物，既能提高工作效率，还能对人的眼睛起到良好的保健作用。</dd>
					</dl>
					<p><img src="images/zx1.jpg" /></p>
				</div>
			</div><!--all_title part for end-->
