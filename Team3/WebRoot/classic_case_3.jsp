		...
		<div class="area_r c_r">
			<div class="news">
				<div class="tab01">
					 ...
					 <li><a href="myqueryAll.action?name=classic_case&typename=别墅&page=1">别&nbsp;&nbsp;&nbsp;&nbsp;墅</a></li>
						<li><a href="myqueryAll.action?name=classic_case_1&typename=公装&page=1">公&nbsp;&nbsp;&nbsp;&nbsp;装</a></li>
						<li><a href="myqueryAll.action?name=classic_case_2&typename=复式&page=1">复&nbsp;&nbsp;&nbsp;&nbsp;式</a></li>
						<li  class="active"><a href="myqueryAll.action?name=classic_case_3&typename=精品公寓&page=1">精品公寓</a></li>
					 </ul>
				</div>
				...
				<div class="cont01">
					<div class="product_main">
						<ul class="clearfix">
							<c:forEach var="list" items="${requestScope.mt.list }" begin="${(requestScope.page-1)*size }" end="${requestScope.page*size-1 }">
				<a href="myqueryAll.action?name=classic_case_main&typename=精品公寓&page=1"><img src="${list.exp_cover }" /></a>
