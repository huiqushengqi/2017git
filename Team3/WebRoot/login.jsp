		...
		<div class="container demo-1">
			<div class="content">
				<div id="large-header" class="large-header">
					...
					<div class="logo_box">
						<h3>欢迎你</h3>
						<form action="lf_login.action" method="post">
							...
							<input type="submit" value="登录" class="act-but submit" style="color: #FFFFFF;width:325px"><br>
							<a href="javascript:history.go(-1)"><label style="color: #FFFFFF">返回上一层</label></a>
						</form>
					</div>
				</div>
			</div>
