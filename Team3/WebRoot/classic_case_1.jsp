			...
			<div class="news">
				<div class="tab01">
					 ...
					 <li><a href="myqueryAll.action?name=classic_case&typename=别墅&page=1">别&nbsp;&nbsp;&nbsp;&nbsp;墅</a></li>
						<li  class="active"><a href="myqueryAll.action?name=classic_case_1&typename=公装&page=1">公&nbsp;&nbsp;&nbsp;&nbsp;装</a></li>
						<li><a href="myqueryAll.action?name=classic_case_2&typename=复式&page=1">复&nbsp;&nbsp;&nbsp;&nbsp;式</a></li>
						<li><a href="myqueryAll.action?name=classic_case_3&typename=精品公寓&page=1">精品公寓</a></li>
					 </ul>
				</div>
				...
				<a href="myqueryAll.action?name=classic_case_main&typename=公装&page=1"><img src="${list.exp_cover }" /></a>
