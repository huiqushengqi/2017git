...
typeof JSON != "object" && (JSON = {}),
	function() {
		...
		typeof JSON.stringify != "function" && (JSON.stringify = function(a, b, c) {
			...
			if(rep = b, b && typeof b != "function" && (typeof b != "object" || typeof b.length != "number")) throw Error("JSON.stringify");
			return str("", {
				"": a
			})
			...
			function walk(a, b) {
				...
				if(e && typeof e == "object")
					for(c in e) Object.prototype.hasOwnProperty.call(e, c) && (d = walk(e, c), d !== void 0 ? e[c] = d : delete e[c]);
