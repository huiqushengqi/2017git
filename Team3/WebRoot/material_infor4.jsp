			...
			<div class="news">
				<div class="tab01">
					 <ul class="m_p clearfix">
						...
						<li class="active"><a href="quote.action?name=material_infor4&typename=窗帘&page=1">窗&nbsp;&nbsp;&nbsp;&nbsp;帘</a></li>
					 </ul>
				</div>
				...
				<div class="page">
							<pt:page pageIndex="${requestScope.page}" url="myquote.action?name=material_infor4&typename=窗帘&" pageMax="${requestScope.countpage}"/>
						</div>
			   </div><!--infor for end-->
