...
<head>
    ...
    if(confirm("你确定要删除此项？")){
      location.href="delete.action?mag_id="+op;
...
<jsp:include page="AdminCom.jsp"></jsp:include> 
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="Admin.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">人事管理</span></div>
        </div>
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="addmanager.jsp"><i class="icon-font"></i>新增成员</a>
                ...
                <div class="result-content">
                   <table class="result-tab" width="100%">
                        ...
                        <tr>
                            <td class="tc">
                            <input name="checked" value="${mytob.mag_id}" type="checkbox">
                            </td>
                            <td ><a target="_blank" href="#" >${mytob.mag_name}</a> 
                            </td>                     
                            
                            <td>${mytob.mag_job}</td>
                            <td>${mytob.mag_date}</td>
                            <td>
                                <a class="link-update" href="overmanager.action?mag_id=${mytob.mag_id}">查看</a>
                                <a class="link-update" href="editmanager.action?mag_id=${mytob.mag_id}">修改</a>
                                <a class="link-del" onclick="mydelete(${mytob.mag_id})">删除</a>
                            </td>
                        </tr>
                        </c:forEach>
                         </table>
