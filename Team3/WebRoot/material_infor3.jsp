			...
			<div class="news">
				<div class="tab01">
					 <ul class="m_p clearfix">
						...
						<li class="active"><a href="myquote.action?name=material_infor3&typename=涂料&page=1">涂&nbsp;&nbsp;&nbsp;&nbsp;料</a></li>
				...
				<div class="page">
							<pt:page pageIndex="${requestScope.page}" url="myquote.action?name=material_infor3&typename=涂料&" pageMax="${requestScope.countpage}"/>
						</div>
			   </div><!--infor for end-->
