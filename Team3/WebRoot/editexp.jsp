    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="updateexp.action" method="post" id="myform" name="myform" enctype="multipart/form-data">
                <input type="hidden" name="exp_id" value="${requestScope.exp.exp_id}">
                <input type="hidden" name="exp_img1" value="${requestScope.exp.exp_img}">
                    <div class="img_list" style="margin-left:140px; border:solid #2f96b4;width: 219px;height: 200px;">
                    <img src="${requestScope.exp.exp_img}" />  
                    </div>
                    <div class="upload">   
                       <input class="file_input" type="file" name="exp_img" id="avc"  />  
                        <div class="upload_box"> 更换照片  </div> 
                        </div>
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red"></i>风格：</th>
                            <td>
                             <input class="common-text required" id="name" name="exp_name" size="10" value="${requestScope.exp.exp_name}">
                            </td>
                        </tr>
                                        
                            <tr>
                                <th>介绍：</th>
                                <td><textarea name="exp_content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10">${requestScope.exp.exp_content}</textarea></td>
                            </tr>          
                        </tbody></table>  
                        </div>
                           <br>
