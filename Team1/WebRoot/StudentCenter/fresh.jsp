...
$.getJSON("getmypage.action",{student_id:${sessionScope.student.student_id},type_id:4,page:current},function(data){
						...
						<div class="module">
							...
							<div class="module-body table">
								<div id="DataTables_Table_0_wrapper" class="dataTables_wrapper"
									...
									$.getJSON("sumpage.action",{student_id:${sessionScope.student.student_id},type_id:4},function(data){
									$("#mypage").pagination({
									   currentPage: 1,// 当前页数
									   totalPage: data,// 总页数
									   isShow: true,// 是否显示首尾页
