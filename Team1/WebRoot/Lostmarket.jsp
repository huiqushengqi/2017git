	...
	$("#link-buttons > a").removeClass("cur");
			...
			<div id="page-post">
				<div class="breadcrumb-trail">
					...
					<a href="post1.action?postid=${post.post_id}&thispage=1">${requestScope.post.post_title}</a>
				</div>
				<div class="post-body" id="post-read">
						...
						<div class="post-card" >
							...
							<div class="post-owner">
								...
								<a class="portrait-container" href="user.php?uid=2043"> <img
										class="portrait" src="${requestScope.post.post_student.student_head }">
								</a>

								<p class="nickname text-line-limit"
									title="${requestScope.post.post_student.student_name }">
									${requestScope.post.post_student.student_name }
								</p>
							</div>
							<div class="post-main">
								...
								<div class="content">
									<div class="body file-read image-click-view">
										<p>
											${requestScope.post.post_depict}
									    </p>
										<p>
											<img src="Lost/${requestScope.img}" />
											<br />
										</p>
									</div>
								</div>
			     ...
			     <c:forEach items="${requestScope.list}" var="list" varStatus="i">
						<div class="post-card" >
							<div id="17122506"
								style="position: absolute; visibility: hidden; top: -54px;"></div>
							<div class="post-owner">
								<a class="portrait-container" href=""> <img
										class="portrait" src="picture/${list.comment_student.student_head }"> </a>
								<p class="username">
									<a href="">${list.comment_student.student_name }</a>
								</p>
							...
							<div class="input-wrapper content-input">
								<textarea name="content" placeholder=""></textarea>
									...
									<div class="input-wrapper">
									    ...
									    <input type="hidden" name="studentid" value="${post.post_student.student_id}"/>
									</div>
			...
			<div class="paging">
				...
				<c:forEach items="${list1}" var="list1">
					<div class="paging-button n active">
						<a class="link" href="post1.action?thispage=${list1}">${list1}</a>
					</div>
				</c:forEach>
				<div class="paging-input-wrapper">
