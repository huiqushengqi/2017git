	...
	<div id="page-thread" class="page-thread">
		...
		<div id="board-head" data-bid="165">
			<div id="title-wrapper">
				<div id="title" class="gray limit">
					<span class="title-text eng">Confession Wall</span> <span
						class="title-text black">表白墙</span>
				</div>
			...
			<div id="content" class="gray">
				<div id="intro" class="limit">我们要在一起</div>
		...
		<div id="board-body">
				...
				<div id="list-content" class="fw">
					...
					<div class="list-item" data-itemid="3675921">
						...
						<div class="title-cont l">
							<div class="title l limit" style="max-width: 456px;">因为爱情</div>
							<img src="img/bl.png">
						</div>
						<div class="avatar l">
					...
					<c:forEach items="${requestScope.list }" var="post">
						...
						<div class="list-item-topic list-item" data-itemid="16261158">
							<a class="link"
								href="market2.action?id=${post.post_id}"></a>
			...
			<div class="paging">
				<div class="paging-button n">
					<a class="link" href="Cpage.action?page=1"></a>1
				</div>
				<div class="paging-button n">
					<a class="link" href="Cpage.action?page=2"></a>2
				</div>
			</div>
		</div>
		<!-- end board-body -->
		...
		<div class="editor-wrapper">
			...
			<div id="bdwm-editor" class="bdwm-editor" data-bid="165"
				...
				'
				<form action="Confessionpost.action" method="post"
