    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            ...
            <ul class="hornav blogmenu">
                <li class="current"><a href="allposts.jsp">All Post (5)</a></li>
                <li><a href="published.jsp">Published (5)</a></li>
                <li><a href="draft.jsp">Draft (3)</a></li>
                <li><a href="trash.jsp">Trash (1)</a></li>
            </ul>
        </div><!--pageheader-->
